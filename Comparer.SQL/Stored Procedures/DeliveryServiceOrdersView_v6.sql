create proc DeliveryServiceOrdersView_v6 
(
...
begin
	...
	select o.ID as 'InnerId',
	    ...
	    iif(w.ReturnedOrderId is not null and w.DocSource = 2 and o.STATUS <> 6, cast(1 as bit), cast(0 as bit))	as 'PartialReturned',
