create proc TrackingRetryOrdersView
(
...
begin
	...
	select
		...
		case 
			when o.PUBLICNUMBER = '' 
				...
				o.PUBLICNUMBER end		as 'PublicNumber', 
	...
	where
		...
		and do.ChangedDate > dateadd(month, -6, getdate())
		and do.StatusId IN (1, 2, 3)
		and do.ServiceId = @ServiceId
		and do.AccountId = @AccountId
	order by
		o.[DATE]
