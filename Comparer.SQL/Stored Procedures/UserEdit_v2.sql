...
begin
	...
	begin try 
		...
		begin
			insert USERS (ID, NAME, USERSGROUP, Password, FirstName, Patronymic, LastName, Email,Status)
			values (@UserId, @Name, @UserGroupId, @Password, @FirstName, @Patronymic, @LastName, @Email,@Status)
		end
		else
		begin 
			update USERS
